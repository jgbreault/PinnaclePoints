# The Longest Lines of Sight on Earth and Pinnacle Points
...
**1. The longest lines of sight.** Every pair of summits that could plausibly see one another is tested to find the longest ground-to-ground lines of sight on Earth. Only lines of sight that are over 300 km long and between summits with more than 300 m of prominence each are considered.
...
│       ├── longest_los/
│       │   ├── longest_los.csv            # All lines of sight over 300 km
│       │   └── longest_los_max.csv        # Longest for each summit (shown on map)
│       └── pinnacle_points/
│           ├── iso/
│           │   └── pinnacle_points.csv    # From the isolation dataset
│           ├── prm/
│           │   └── pinnacle_points.csv    # From the prominence dataset
│           └── prm_iso/
│               ├── pinnacle_points.csv         # Final merged result (shown on map)
│               └── pinnacle_points_merged.csv  # Intermediate merge before dedup
├── misc/
│   ├── images/                            # Plots and figures
│   │   ├── distance_to_nearest_pinnacle_point.png
│   │   ├── longest_los_confirmed.png
│   │   ├── longest_los_JGB.png
│   │   ├── longest_los_map.png
│   │   └── pinnacle_point_map.png
│   ├── math/
│   │   ├── formatted/                     # Rendered math (PDF)
│   │   │   ├── atmospheric_refraction.pdf
│   │   │   ├── atmospheric_scattering.pdf
│   │   │   └── earth_curvature.pdf
│   │   └── raw/                           # Math source (Markdown + pandoc)
│   │       ├── atmospheric_refraction.md
│   │       ├── atmospheric_scattering.md
│   │       └── earth_curvature.md
│   ├── papers/                            # Relevant scientific papers
│   │   ├── atmospheric_structure.pdf
│   │   ├── extreme_visual_ranges.pdf
│   │   ├── ototw.pdf
│   │   ├── prominence_isolation.pdf
│   │   └── sea_level_geoid.pdf
│   ├── presentation/                      # Project presentation
│   │   ├── pinnacle_points_presentation.pdf
│   │   └── pinnacle_points_presentation.pptx
│   ├── method.txt                         # Full explanation of the method
│   └── pinnacle_points_app.apk            # Pinnacle point app for Android
├── scripts/
